 ...
 * @param cb
 */
exports.config.loadConfig = function(cb) {
  if (configData) {
    cb(configData)
  } else {
...
exports.config.saveConfig = function(config,cb) {
 ...
 * @param cb
 */
exports.config.get = function(keyString,cb) {
  exports.config.loadConfig(function(config) {
 ...
 * @param cb
 */
exports.config.set = function(keyString,value,cb) {
  exports.config.loadConfig(function(config) {
    var keyParts = keyString.split('.')
    var obj = config;
    var key;
    ...
    exports.config.saveConfig(config,cb)
  })
}